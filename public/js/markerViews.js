...
function on_mouse_move() {
    if (isEnable == 1) {
        ...
        if (tmp - 0.15 > range && tmp < 1 - range) {
            heightRatio = tmp;
            document.getElementById("section").style.height = window.innerHeight * (heightRatio - 0.15) + "px";
            document.getElementById("footer").style.height = window.innerHeight * (1 - heightRatio) + "px";
        }
    }
}
...
function move_inner(e) {
    ...
    var relativeY = window.innerHeight * 0.85 * 0.5;
