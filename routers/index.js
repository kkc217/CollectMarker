...
let oldFileData = fs.readFileSync(dir + '/changes/change001/old/' + fileList[1],'utf-8');
let newFileData = fs.readFileSync(dir + '/changes/change001/new/' + fileList[1],'utf-8');
